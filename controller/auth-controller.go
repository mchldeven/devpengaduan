...
func (c *authController) Login(ctx *gin.Context) {
	...
	if errDTO != nil {
		response := helper.BuildErrorResponse("Gagal memprosses Request! error!", errDTO.Error(), helper.EmptyObj{})
...
func (c *authController) Register(ctx *gin.Context) {
	...
	if !c.authService.IsDuplicateEmail(registerDTO.Email) {
		response := helper.BuildErrorResponse("Gagal memprosses Request! error!", "Duplicate email", helper.EmptyObj{})
